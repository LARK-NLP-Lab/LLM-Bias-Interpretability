...
MISCLASSIFIED_FILE_TEMPLATE = 'misclassified_samples_with_activations_{model}.jsonl'
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Run C-REACT neuron intervention experiments."
    )
    parser.add_argument(
        "--model",
...
def main():
    ...
    misclassified_file = MISCLASSIFIED_FILE_TEMPLATE.format(model=args.model)
