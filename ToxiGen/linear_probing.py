...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Train a ToxiGen race linear probe and inspect race-associated neurons."
    )
    parser.add_argument(
        "--model",
        default=MODEL_NAME,
        help=(
            ...
            "Supported aliases: qwen, llama, mistral."
        ),
    )
...
def resolve_model_name(model_choice):
    return MODEL_CHOICES.get(model_choice, model_choice)
